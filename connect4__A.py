...
def _ok(r,c):
    ...
    return (B[r][c-1]==' ' and r or _ok(r-1,c))
...
def insert(c):
    ...
    temp_R = _ok(5,c)
    B[temp_R][c-1] = chr(ord("○") + isFilled[0]*4)
...
def makeAmove():
    ...
    str_ordinal=["1st","2nd","3rd","4th","5th","6th","7th"];print("%c chooses the %s column."%(chr(ord("○") + isFilled[0]*4),str_ordinal[c-1]))
    insert(c)
